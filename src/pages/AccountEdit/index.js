    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <MyInput label="Username" iconname="person" value={kirim.username} onChangeText={x => setKirim({ ...kirim, username: x })} />
                <MyGap jarak={10} />
                ...
                <MyGap jarak={10} />
                <MyInput label="Regu Pengamanan" iconname="shield-checkmark" value={kirim.regu} onChangeText={x => setKirim({ ...kirim, regu: x })} />
                <MyGap jarak={10} />
                <MyInput label="Jabatan" iconname="ribbon" value={kirim.jabatan} onChangeText={x => setKirim({ ...kirim, jabatan: x })} />
                <MyGap jarak={10} />
